...
public final class Worldrise {
    ...
    private static final ResourceLocation BUILTIN_PACK_LOCATION = ResourceLocation.fromNamespaceAndPath(MOD_ID, "worldrise_datapack");
    ...
    private void registerBuiltinDatapack(AddPackFindersEvent event) {
        ...
        var packLocationId = "mod/" + BUILTIN_PACK_LOCATION;
        ResourcePackLoader.getPackFor(MOD_ID).ifPresentOrElse(resourcesSupplier -> {
            var pack = Pack.readMetaAndCreate(
                    new PackLocationInfo(
                            ...
                            BUILTIN_PACK_TITLE,
                            PackSource.BUILT_IN,
                            Optional.of(new KnownPack("neoforge", packLocationId, modInfo.getVersion().toString()))
                    ),
                    resourcesSupplier,
