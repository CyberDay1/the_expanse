 ...
 * fit within The Expanse's extended build range. The logic mirrors the standalone
...
public final class HeightRescaler {
    ...
    /**
     * Converts a vanilla-height Y coordinate into the expanded The Expanse range.
     */
